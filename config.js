...
module.exports = {
    ...
    JINN: process.env.ALL_CAPTION === undefined ? '```Made By Shaji pappan 😉```' : process.env.ALL_CAPTION,
    ...
    BOTNME: process.env.BOT_NAME === undefined ? 'Shaji pappan' : process.env.BOT_NAME,
